...
public class to_do extends AppCompatActivity {
    ...
    com.example.dashbord.DBHelper mydb;
    LinearLayout empty;
    NestedScrollView scrollView;
    LinearLayout todayContainer, tomorrowContainer, otherContainer;
    com.example.dashbord.NoScrollListView taskListToday, taskListTomorrow, taskListUpcoming;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydb = new com.example.dashbord.DBHelper(this);
    ...
    public void openAddModifyTask(View view) {
        startActivity(new Intent(this, com.example.dashbord.AddModifyTask.class));
    }
    ...
    public void loadListView(com.example.dashbord.NoScrollListView listView, final ArrayList<HashMap<String, String>> dataList) {
        com.example.dashbord.ListTaskAdapter adapter = new com.example.dashbord.ListTaskAdapter(this, dataList, mydb);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                Intent i = new Intent(com.example.dashbord.to_do.this, com.example.dashbord.AddModifyTask.class);
